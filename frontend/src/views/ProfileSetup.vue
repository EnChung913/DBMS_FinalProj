//TODO: year change to roc era, force transfer student id to uppercase, there's an issue if user
havn't fill in profile and try to access dashboard
...
const profileData = ref({
  student_id: '',
  department_id: '',
  entry_year: new Date().getFullYear() - 1911,
  grade: 1,
  department_name: '',
  company_name: '',
  industry: '',
